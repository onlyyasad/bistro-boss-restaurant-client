...
const SectionCover = ({sectionImg, secHeading}) => {
    return (
        <div className="hero h-[450px]" style={{ backgroundImage: `url("${sectionImg}")` }}>
            <div className="hero-overlay bg-opacity-0"></div>
            <div className="hero-content bg-black bg-opacity-50 text-center text-neutral-content">
                <div className="max-w-4xl p-10">
                    <h1 className="mb-5 text-5xl font-cinzel">{secHeading}</h1>
